...
public class SplashActivity extends Activity {
    ...
    protected void downLoadNewApk() {
        ...
        //先删除掉xx.apk
        File file = new File("/mnt/sdcard/graduation.apk");
        file.delete();//删除文件
        utils.download(parseJson.getUrl(), "/mnt/sdcard/graduation.apk", new RequestCallBack<File>() {
