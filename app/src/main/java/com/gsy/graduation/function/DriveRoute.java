package com.gsy.graduation.function;
 ...
 * 驾车出行路线规划 实现
 */
public class DriveRoute implements OnMapClickListener,
...
//        mHeadLayout.setVisibility(View.GONE);
    ...
    private void registerListener() {
        mAMap.setOnMapClickListener(DriveRoute.this);
        mAMap.setOnMarkerClickListener(DriveRoute.this);
        mAMap.setOnInfoWindowClickListener(DriveRoute.this);
        mAMap.setInfoWindowAdapter(DriveRoute.this);
